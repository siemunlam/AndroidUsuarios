...
public class CustomDecorationDividerEndItem extends RecyclerView.ItemDecoration {
     ...
     */
    public CustomDecorationDividerEndItem(int offsetPx) {
        mOffsetPx = offsetPx;
    }
     ...
     *                       RecyclerView
     */
    public CustomDecorationDividerEndItem(Drawable offsetDrawable) {
